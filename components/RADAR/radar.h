...
// 阈值缩放
#define RADAR_PRESENCE_SCALE 0.015f
#define RADAR_MOTION_SCALE 0.10f

// 为了减少状态来回跳，退出阈值比进入阈值更低一些，形成滞回。
#define RADAR_PRESENCE_EXIT_SCALE 0.75f
#define RADAR_MOTION_EXIT_SCALE 0.80f
#define RADAR_EMPTY_CONFIRM_FRAMES 20
#define RADAR_WANDER_FALLBACK_VALUE 0.02f
